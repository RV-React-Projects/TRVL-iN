	...
	return (
		<div className="footer-container">
			<section className="footer-subscription">
				<p className="footer-subscription-heading">Join On the Adventures Journey Of India</p>
				<p className="footer-subscription-text">you can Subscribe Us for More News</p>
				<div className="input-areas">
					<form>
						<input type="email" name="email" placeholder="Enter Your Email" className="footer-input" />
						<CustButton buttonStyle="btn--outline">Subscribe</CustButton>
					</form>
				</div>
			</section>
